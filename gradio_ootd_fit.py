...
def scale_mask(mask: Image.Image, scale: float) -> Image.Image:
    ...
    scale < 1.0 -> tighter, scale > 1.0 -> looser.
    """
...
def process_hd(vton_img, garm_img, n_samples, n_steps, image_scale, seed,fit_scale):
    model_type = 'hd'
...
with block:
    ...
    with gr.Column():
        ...
        n_steps = gr.Slider(label="Steps", minimum=2, maximum=30, value=12, step=1)
    ...
    ips = [vton_img, garm_img, n_samples, n_steps, image_scale, seed,fit_scale]
